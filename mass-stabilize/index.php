...
<html lang="en">
<head>
	<title>mass-stabilize</title>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<link rel="stylesheet" type="text/css" href="../style.css">
</head>
<body>
	<a href="../">Home</a>
	<h1>mass-stabilize</h1>
	<form action="process.php" method="post">
		...
		<div>
			<label for="default">Default page view: </label>
			<select name="default" id="default">
				<option value="stable" selected="selected">The stable version</option>
				<option value="latest">The latest version</option>
			</select>
		</div>
		<div>
